...
const OrdersTab = () => (
  <div className="space-y-6">
    ...
    <div className="space-y-4">
      {[
        { id: '#BLM-9001', date: 'Jan 24, 2024', total: '₹14999.00', status: 'Processing', items: '1x 20L System Kit (4 Zones)' },
        { id: '#BLM-8822', date: 'Dec 12, 2023', total: '₹2499.00', status: 'Delivered', items: '2x Extension Tubing' },
      ].map((order) => (
        <div key={order.id} className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-8 w-full md:w-auto justify-between md:justify-end">
            ...
            <div className={`px-3 py-1 rounded-full text-xs font-bold ${order.status === 'Delivered'
...
const CartTab = () => {
  ...
  const shipping = 250.00; // Heavier items (Tanks) - updated to reasonable INR shipping
